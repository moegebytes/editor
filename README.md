...
<p align="center">
  Desktop editor for translating Visual Novel scripts with built-in dictionaries.
</p>
...
A human in the loop has read code and directed LLM to specific architectural choices. In rare cases, where LLM failed,
...
- **Glossary** - Define translations terms per project. Glossary terms are highlighted inline in the Japanese source text with tooltips showing the expected translation.
...
| Editor                                         | Find & Replace                                            |
|------------------------------------------------|-----------------------------------------------------------|
| ![Editor view](.github/screenshots/editor.png) | ![Find and replace](.github/screenshots/find-replace.png) |

| Dictionary                                              | Glossary                                      |
|---------------------------------------------------------|-----------------------------------------------|
| ![Dictionary panel](.github/screenshots/dictionary.png) | ![Glossary](.github/screenshots/glossary.png) |

| Settings                                      | Project Home                                          |
|-----------------------------------------------|-------------------------------------------------------|
| ![Settings](.github/screenshots/settings.png) | ![Project home](.github/screenshots/project-home.png) |
